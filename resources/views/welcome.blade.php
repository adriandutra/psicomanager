            ...
            <div class="row no-gutters">
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <h3>Agenda Online</h3>
                        <p>Olvídese de su horario en papel, programe citas y horarios de atención al cliente de una manera más sencilla, integrada con su teléfono celular. Reciba recordatorios por teléfono celular o correo electrónico. También se integra con Google Calendar o iCalendar.</p>
                        <a href="#" class="boxed-btn3-white">Más Info</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Organice sus cuentas por cobrar y cuentas por pagar. Controle los pagos de sus clientes con la posibilidad de pagar paquetes y convenios. Genere informes para tomar decisiones inteligentes. Genere cobros a sus clientes en 2 clics recibiendo pagos directamente del cliente, vía boleto o tarjeta de crédito.</p>
                        <a href="#" class="boxed-btn3-white">Más Info</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_service">
                        ...
                        <p>Anota y organiza las sesiones de tus clientes. De forma eficiente y segura, podrá acceder a la historia clínica de sus clientes. Posibilidad de generar hojas de cálculo organizadas y formularios de anotación personalizados. Cree su propio formulario de anamnesis, por perfil de cliente.</p>
                        <a href="#" class="boxed-btn3-white">Más Info</a>
                    </div>
                </div>
            </div>
