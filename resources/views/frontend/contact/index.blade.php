            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Contacto</h3>
                        <p><a href="{{url('/')}}">Inicio /</a> Contacto</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ingrese Mensaje'" placeholder=" Ingrese Mensaje"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Morón, Buenos Aires.</h3>
                                <p>25 de mayo, CP 1708</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+54 11 3421 3418</h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>support@redpsicologia.com.ar</h3>
                                <p>Enviénos su consulta!</p>
                            </div>
                        </div>
                    </div>
                </div>
